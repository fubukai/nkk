...
from .models import Course_D, MT_User, List_Dept, List_Emp, Course_Director, Check_Loginerror, Check_Staff_End,Subject,Competency,Relation_course
...
admin.site.register(Relation_course)
